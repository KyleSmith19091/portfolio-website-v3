...
### Sections
- <a href="#1">What is an LSM-tree?</a>
- <a href="#2">Memtable</a>
- <a href="#3">LSM Storage Engine State</a>
- <a href="#4">Concurrency</a>
...
```
<span className="flex justify-center text-sm text-gray-400">Snippet 3: LSM Storage Engine State</span>
...
```
<span className="flex justify-center text-sm text-gray-400">Snippet 4: LSM Storage State Wrapper</span>
...
```
<span className="flex justify-center text-sm text-gray-400">Snippet 5: LSM Storage Engine Write Path</span>
...
```
<span className="flex justify-center text-sm text-gray-400">Snippet 6: LSM Storage Engine Memtable Freeze Checking</span>
...
```
<span className="flex justify-center text-sm text-gray-400">Snippet 7: LSM Storage Engine Memtable Freezing Procedure</span>
